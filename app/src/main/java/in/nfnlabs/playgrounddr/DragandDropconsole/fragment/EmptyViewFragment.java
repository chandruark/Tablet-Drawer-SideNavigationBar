...
public class EmptyViewFragment extends BaseFragment {
    ...
    protected List<MonthItem> getMonths() {
        ...
        monthList.add(new Month("JAN", R.drawable.user_profile_male));
        monthList.add(new Month("FEB", R.drawable.user_profile_male));
        monthList.add(new Month("MAR", R.drawable.user_profile_male));
        monthList.add(new Month("APR", R.drawable.user_profile_male));
        monthList.add(new Month("MAY", R.drawable.user_profile_male));
        monthList.add(new Month("JUN", R.drawable.user_profile_male));
